...
cd ../01-Poisson
python setup.py build_ext --inplace --include-dirs="../../C++/01-Poisson/:$HERMES_DIR/include/hermes_common/:$HERMES_DIR/include/hermes2d/:$HERMES_WRAPPERS_DIR/hermes2d/:$HERMES_WRAPPERS_DIR/hermes_common/:../../C++/Common/" --library-dirs="../../C++/01-Poisson/:$HERMES_DIR/lib/:../Common/" --pyrex-include-dirs="$HERMES_WRAPPERS_DIR/hermes2d/:$HERMES_WRAPPERS_DIR/hermes_common/:../Common/"
