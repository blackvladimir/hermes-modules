...
cd Common
python setup.py build_ext --inplace --include-dirs="$MODULES_DIR/include/hermes_module/:$HERMES_DIR/include/hermes_common/:$HERMES_DIR/include/hermes2d/:$HERMES_WRAPPERS_DIR/hermes2d/:$HERMES_WRAPPERS_DIR/hermes_common" --library-dirs="$MODULES_DIR/lib/:$HERMES_DIR/lib" --pyrex-include-dirs="$HERMES_WRAPPERS_DIR/hermes2d/:$HERMES_WRAPPERS_DIR/hermes_common" install_lib
cd ../01-Poisson
python setup.py build_ext --inplace --include-dirs="$MODULES_DIR/include/hermes_module/:$HERMES_DIR/include/hermes_common/:$HERMES_DIR/include/hermes2d/:$HERMES_WRAPPERS_DIR/hermes2d/:$HERMES_WRAPPERS_DIR/hermes_common/:$MODULES_DIR/include/hermes_module/" --library-dirs="$MODULES_DIR/lib/:$HERMES_DIR/lib/" --pyrex-include-dirs="$HERMES_WRAPPERS_DIR/hermes2d/:$HERMES_WRAPPERS_DIR/hermes_common/:../Common/" install_lib
